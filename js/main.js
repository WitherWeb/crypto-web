...
/* harmony import */ var _components_copy_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_copy_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_switcher_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/switcher.js */ "./src/js/components/switcher.js");
/* harmony import */ var _components_switcher_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_switcher_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_disableBtn_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/disableBtn.js */ "./src/js/components/disableBtn.js");
/* harmony import */ var _components_disableBtn_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_disableBtn_js__WEBPACK_IMPORTED_MODULE_3__);
...
const copy = document.querySelectorAll('.card__contract-copy');
const copyText = document.querySelector('.card__contract-contract');
const copyComplied = document.querySelector('.complied-copy');
const copyTextRef = document.querySelector('.card__label-partners');
const copyRef = document.querySelector('.partners__copy-ref');
const copyClose = document.querySelector('.complied-copy-close');
copy.forEach(el => {
  el.addEventListener('click', () => {
    navigator.clipboard.writeText(copyText.innerHTML);
    copyComplied.classList.add('is-active');
    setTimeout(function () {
      copyComplied.classList.remove('is-active');
    }, 3000);
  });
});
copyRef === null || copyRef === void 0 ? void 0 : copyRef.addEventListener('click', () => {
  navigator.clipboard.writeText(copyTextRef.innerHTML);
  copyComplied.classList.add('is-active');
  setTimeout(function () {
    copyComplied.classList.remove('is-active');
  }, 3000);
...
/***/ "./src/js/components/disableBtn.js":
/*!*****************************************!*\
  !*** ./src/js/components/disableBtn.js ***!
  \*****************************************/
/***/ (() => {

const btnOff = document.querySelectorAll('.card__btn--off');
const inputOff = document.querySelectorAll('.card__input--off');
btnOff.forEach(e => {
...
function selectChoose() {
  ...
  let img = this.querySelector('.select__img').getAttribute('src');
  currentText = select.querySelector('.select__current');
  currentImg = select.querySelector('.select__img-current');
...
const switcher = document.querySelectorAll('.switcher__radio--dark');
switcher.forEach(e => {
